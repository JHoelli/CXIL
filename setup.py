...
setuptools.setup(
    ...
    package_data={
   'XIL.Data.data': ['*'],
   # XIL/Data/data/decoy-mnist
    'XIL.Data.data.decoy-mnist': ['*'],
    'XIL.Data.data.split-mnist': ['*'],
    'XIL.Data.data.split-decoy-mnist': ['*'],
    'XIL.Data.data.TimeSeries': ['*'],
    'XIL.Data.data.TimeSeries.Testing': ['*'],
    'XIL.Data.data.TimeSeries.Training': ['*'],
    'XIL.Data.data.TimeSeries.Testing.data': ['*'],
    'XIL.Data.data.TimeSeries.Training.data': ['*'],
